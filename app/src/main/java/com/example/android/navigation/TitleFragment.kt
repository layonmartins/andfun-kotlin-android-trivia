...
class TitleFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // TODOone (09) Call binding.playButton.setOnClickListener and navigate to the gameFragment
    ...
    // TODOone (06) Add the Title Fragment to the Navigation Graph
    ...
    // TODOone (08) Connect the Title and Game Fragments with an Action
