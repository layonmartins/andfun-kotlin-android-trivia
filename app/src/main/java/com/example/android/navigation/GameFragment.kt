            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        // TODOne (05) Find the navController from the view and navigate to the gameWonFragment
                    ...
                    // TODOne (06) Find the navController from the view and navigate to the gameOverFragment
                    // call view.findNavController
